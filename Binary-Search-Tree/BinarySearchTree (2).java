 ...
 * @version <12/05/2015>
 */
public class Lab13BinarySearchTree<T extends Comparable<? super T>>
     ...
     */
    public T findMax() {
        BinaryNode<T> larg = root;
        return elementAt(findMax(larg));
    }
    ...
    private BinaryNode<T> remove(T x, BinaryNode<T> node) {
        ...
        // If value is on the current node
            ...
            if (node.getLeft() != null && node.getRight() != null) {
                BinaryNode<T> removed = findMax(node.getLeft());
                node.setElement(elementAt(removed));
    ...
    /**
     * @param node
     *            no be set to the next
     * @return the removed
     */
    private BinaryNode<T> removeLargest(BinaryNode<T> node) {
