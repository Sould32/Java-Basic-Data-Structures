...
public class DLList<E> implements Iterable<E> {
     ...
     */
    // last index is a core method for this to work
    ...
    public void add(int index, E obj) {
        ...
        // node after is the node at index
        Node<E> nodeAfter;
        if (index == size) {
            nodeAfter = tail;
        } else {
     ...
     */
    // node start at head.next and and the loop go to index
    // cannot reach tails.next because of size
    ...
    public int lastIndexOf(E obj) {
        /*
         * We should go from the end of the list as then we can stop once we
         * find the first one
         */
        Node<E> current = tail.previous();
        // count downward (from tail.previous) and size = 0 if the list is empty
    ...
    public boolean remove(int index) {
        ...
        System.out.println(nodeToBeRemoved.data);
    ...
    public class RDLListIterator<A> implements Iterator<E> {
        ...
        public void remove() {
            if (nextCalled) {
                ...
                throw new IllegalStateException("Iterator unable to remove elements");
            }
        }
    }
    /**
     ...
     */
    // used the tail as where to stop looping
