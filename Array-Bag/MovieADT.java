...
/**
 * MovieADT interface to represent a movie to be stored in a movie collection.
 * Each movie object has a title (string), genre (string), rating (int), and
 * year (int).
 *
...
public abstract class MovieADT {
    ...
    // ----------------------------------------------------------
    /**
     * Determines if two objects are equal. Two movies are equal if they have
     * the same title.
     * @param other of type Movie
